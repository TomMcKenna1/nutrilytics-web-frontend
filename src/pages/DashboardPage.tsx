...
const DashboardPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Meal generation started! (Draft ID: ${draftId})`);
      setMealInput('');
  ...
  return (
    <div>
      ...
      <p>This is your dashboard. You can view your meal history or log a new meal below.</p>
